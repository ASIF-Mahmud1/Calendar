...
import { faCalendarPlus, faThumbsDown, faThumbsUp, faSignInAlt, faSignOutAlt, faCalendarCheck, faBackward, faArrowLeft } from '@fortawesome/free-solid-svg-icons'
...
const styles = StyleSheet.create({
    HeaderButton: {width: 100,marginTop:20,marginRight:10 },
    signIn: { marginTop: 15, marginLeft: 250 },
    back: { marginTop: 20, marginRight:290 },
